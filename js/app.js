document.addEventListener("DOMContentLoaded", function () {
  ...
  const getLocation = async () => {
    const response = await fetch("https://ipinfo.io/json?token=06f1f115861750");
  ...
  const getTemperature = async (lat, lon) => {
    const url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=c313a35c8ef04ea4a26f41b8f67d7b32`
